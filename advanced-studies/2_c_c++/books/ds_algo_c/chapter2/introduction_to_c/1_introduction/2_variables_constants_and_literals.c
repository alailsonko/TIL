/*
## C variables, Constantes and literals
In this tutorial, you will learn about variables
and rules for naming a variable. You will also
learn about different literals in C programming 
...
the decimal values in C, you need to declare it type to either 'double' or 'float'.
...
Here, 1, 2.5, 'c' are literals.Why? you cannot assign differen values to
these terms.

#### 1. Integers 
      An integer is a numeroc literal(associated with numbers) without any 
      ...
      * Hexadecimal: 0x7f, 0x2a, 0x521 etc
      In C programming, ocal starts with a '0', and hexadecimal
      starts with a 0x.
...
#### 3. Characters
      ...
      inside single quotation marks. For example: 'a', 'm', 'F', '2', '}' etc.
...
#### 4. Escape Sequences
      ...
      In order to use these characters, escape sequences are used.
        ...
        \?	Question mark
        \0	Null character
      | For example: \n is used for a newline. The backslash \ causes escape 
      from the normal way the characters are handled by the compiler.
...
changed, you can use the 'const' keyword. This will create a constant.
For example:
...
Here, PI i a symbolic constant; its value cannot be changed.

> const double PI = 3.14;
> PI = 2.9; // Error
-----------------------------
You can also define a constant using the #define preprocessor
directive. We will learn about it in C Macros.
